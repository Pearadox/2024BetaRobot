...
public final class Constants {
  ...
  public static final class SwerveConstants{
    ...
    public static final double LEFT_FRONT_OFFSET = -0.276;
    public static final double RIGHT_FRONT_OFFSET = -0.189;
    public static final double LEFT_BACK_OFFSET = 0.225;
    public static final double RIGHT_BACK_OFFSET = 0.304;
    ...
    //Teleop constraints
    public static final double TELE_DRIVE_MAX_SPEED = DRIVETRAIN_MAX_SPEED * 0.35; //changed for demo
    public static final double TELE_DRIVE_MAX_ANGULAR_SPEED = (DRIVETRAIN_MAX_ANGULAR_SPEED / 1.25) *0.5 ; //changed for demo
