...
public final class Constants {
  ...
  public static final class SwerveConstants{
    ...
    public static final double LEFT_FRONT_OFFSET = -0.2678; // -0.03564;
    public static final double RIGHT_FRONT_OFFSET = -0.1852; // 0.43579;
    public static final double LEFT_BACK_OFFSET = 0.2276; // 0.40991;
    public static final double RIGHT_BACK_OFFSET = 0.3115; // -0.09301;
    //TODO: swerve offsets
